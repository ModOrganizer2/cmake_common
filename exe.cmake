...
function(deploy_qt)
	...
	if(NOT ${deploy_qt_NOPLUGINS})
		install(CODE "
			file(COPY ${bin}/QtPlugins/imageformats DESTINATION ${dlls}/QtPlugins)
			file(COPY ${bin}/QtPlugins/platforms DESTINATION ${dlls}/QtPlugins)
			file(COPY ${bin}/QtPlugins/styles DESTINATION ${dlls}/QtPlugins)
			file(COPY ${bin}/QtQuick.2 DESTINATION ${dlls}/QtImports)
			file(COPY ${bin}/QtWebEngineProcess.exe DESTINATION ${dlls})
			file(COPY ${bin}/resources DESTINATION ${dlls})
			file(COPY ${bin}/translations DESTINATION ${dlls})
			file(REMOVE_RECURSE ${bin}/QtPlugins)
			file(REMOVE_RECURSE ${bin}/QtQuick.2)
			file(REMOVE_RECURSE ${bin}/QtWebEngineProcess.exe)
			file(REMOVE_RECURSE ${bin}/resources)
